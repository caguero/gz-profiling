...
\begin{center}
\url{https://github.com/caguero/gz-profiling-flamegraphs}
\end{center}

Interactive flamegraphs are served via GitHub Pages at:

\begin{center}
\url{https://caguero.github.io/gz-profiling-flamegraphs/}
\end{center}

The repository contains everything needed to reproduce the study:

\begin{verbatim}
gz-profiling-flamegraphs/
...
\def\BASEURL{https://caguero.github.io/gz-profiling-flamegraphs/2026-04-21}
